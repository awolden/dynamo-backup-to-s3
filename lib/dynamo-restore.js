...
function DynamoRestore(options) {
    ...
    options.awsKey = options.awsKey;
    options.awsSecret = options.awsSecret;
    options.awsRegion = options.awsRegion || 'ap-southeast-2';
...
DynamoRestore.prototype._validateS3Backup = function(options) {
    ...
    options.s3bucket = options.s3bucket || url.hostname;
    options.s3path = options.s3path || url.pathname.substr(1);
